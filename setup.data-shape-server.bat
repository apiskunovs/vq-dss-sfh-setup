...
echo Git cloning...
echo ====================================================================
git clone https://github.com/LUMII-Syslab/data-shape-server.git %folder%
cd %folder%
...
echo ====================================================================
set fndir=..\additions\files\data-shape-server\
if exist %fndir% (
...
echo ====================================================================
set zipdir=..\additions\archives\data-shape-server\
if exist %zipdir% (
